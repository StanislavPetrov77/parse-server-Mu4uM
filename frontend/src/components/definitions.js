...
export const B4A = window.location.host === 'my4um-server.b4a.app'

export const B4A_APP_ID = 'DUOfe0DIvESBzY0JgbkR7GPSHQpVeTMx6FgNFeuQ'
export const B4A_JS_KEY = 'A21ayFe8LvMXaXOOVj0E1VoyieBbngjMQUTP12Sp'
export const B4A_SERVER_URL = 'https://my4um-server.b4a.io'
export const B4A_LIVE_QUERY_SERVER_URL = 'wss://my4um-server.b4a.io'
